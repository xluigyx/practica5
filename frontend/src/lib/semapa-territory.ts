// ============================================================
// SEMAPA COCHABAMBA — DATOS TERRITORIALES
// Jerarquía: 6 Comunas → 15 Distritos → Zonas
...
export interface ComunaConfig {
  ...
  nombre: string;
  color: string;
  colorDark: string;        // versión oscurecida para bordes
  distritoIds: number[];
  labelPos: [number, number]; // posición del label en nivel comunas
}
...
export const DISTRITO_BOUNDARIES: DistritoBoundary[] = [
  ...
  },
  {
    ...
    centroid: [128, 689],
    zonas: ['Sarco', 'Hipódromo', 'Sarcobamba', 'Villa Busch', 'Chiquicollo'],
  },
  {
    id: 4,
    nombre: 'D-4 Hipódromo',
    comunaId: 'molle',
    points: '60,732 92,819 139,851 147,984 102,1034 60,994 28,899 37,797',
    centroid: [88, 884],
    zonas: ['Hipódromo', 'La Chimba', 'Villa Busch', 'Coña Coña'],
  },
  {
    id: 10,
  ...
  },
  {
    ...
    centroid: [455, 769],
    zonas: ['Sarco', 'Cala Cala', 'Queru Queru', 'Tupuraya', 'Hipódromo'],
  },
  {
    id: 11,
  ...
  },
  {
    ...
    centroid: [92, 1075],
    zonas: ['La Maica', 'Coña Coña', 'Tamborada Pukarita', '1° de Mayo', 'Pukara Grande Norte', 'Valle Hermoso Oeste', 'Pukara Grande Sur', 'Pukara Grande Oeste'],
  },
  {
    id: 15,
